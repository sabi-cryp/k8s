...
```
$ docker image tag jhipstergatewaydemo sabrineker/jhipstergatewaydemo
$ docker push sabrineker/jhipstergatewaydemo
$ docker image tag userapp sabrineker/userapp
$ docker push sabrineker/userapp
```
...
```
$ kubectl get svc jhipstergatewaydemo -n pfe
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n pfe
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n pfe
```
...
```
$ kubectl get svc jhipster-prometheus -n pfe
```
...
```
$ kubectl get svc jhipster-grafana -n pfe
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n pfe
```

and explore the details using

```
$ kubectl get svc exposed-registry -n pfe
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n pfe
```
